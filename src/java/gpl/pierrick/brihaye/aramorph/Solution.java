...
public class Solution {
	...
	protected Solution(boolean debug, int cnt, DictionaryEntry prefix, DictionaryEntry stem, DictionaryEntry suffix) {
		...
		this.stem = stem;
		this.suffix = suffix;
		prefixesPOS = new LinkedList(Arrays.asList(prefix.getPOS()));
		stemsPOS = new LinkedList(Arrays.asList(stem.getPOS()));
		suffixesPOS = new LinkedList(Arrays.asList(suffix.getPOS()));
		prefixesGlosses = new LinkedList(Arrays.asList(prefix.getGlosses()));
		stemsGlosses = new LinkedList(Arrays.asList(stem.getGlosses()));
		suffixesGlosses = new LinkedList(Arrays.asList(suffix.getGlosses()));
